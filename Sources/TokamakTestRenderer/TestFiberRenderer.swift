...
public final class TestFiberElement: FiberElement, CustomStringConvertible {
  ...
  public var description: String {
    let memoryAddress = ObjectIdentifier(self)
...
public final class TestFiberRenderer: FiberRenderer {
  ...
  public func commit(_ mutations: [Mutation<TestFiberRenderer>]) {
    ...
    func assertReachable(_ el: TestFiberElement) {
      if !isReachable(el) { fatalError("element not reachable from root") }
    }
  ...
  public func preferencesChanged(_ preferenceStore: TokamakCore._PreferenceStore) {}
}
